...
<?php 
	...
	// if ($dbtype == 1) {
	// 	    include 'family_about.php';
	// }else if ($dbtype == 2) {
	// 		include 'doctor_about.php';
	// }else if ($dbtype == 3) {
	// 		include 'educator_about.php';
	// }else if ($dbtype == 4){
	// 		include 'everyone_about.php';
	// }
?>
<!DOCTYPE html>
<html>
...
<body>
	...
	$about_query = mysqli_query($conn,"SELECT city,hometown,queote,bio,mobile,pub_email,relationship FROM users WHERE username='$username'");
