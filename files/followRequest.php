		...
		<div style="width: 900px; margin: 52px auto;">
			...
			<div style="float: right;">
				 <div class="notificationbox">
				 	<h2  style="float: left; color: #505050;">Follow Request</h2>
				 	<div style='max-height: 500px; overflow: auto; width: 556px;'>
				 		<ul>
				 			<li style='line-height: 8px;'>
				 				<?php 
				 					//getting post comment
									$get_followR = mysqli_query($conn,"SELECT * FROM follow WHERE user_to ='$user' ORDER BY id DESC LIMIT 50");
			...
			$profile_pic = "userdata/profile_pics/".$profile_pic_db;
											...
											echo "<div style='margin: 10px; padding: 7px 0px;'>";
												...
												echo "<div style='margin: 0 0 0 50px; line-height: 1.4;'>";
													echo "<b><a href='profile.php?u=$user_from' style='text-decoration: none; font-size: 15px; color: #505050;'  class='posted_by'>$user_from_fname</a></b><span style='font-size: 15px; margin-left: 10px;'>".$comment_disp."</span>
													"; 
