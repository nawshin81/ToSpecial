...
$username ="";
if (isset($_GET['u'])) {
	$username = ($_GET['u']);   //mysqli_real_escape_string
...
//chat count 
$buddyList = '0';
$getonlineuser = mysqli_query($conn,"SELECT first_name,username FROM users WHERE (chatOnlineTime>=now()-300)") or die(mysqli_error());
...
<div style="width: 900px; margin: 52px auto;">
	<ul>
		<li style="float: left;">
			...
			<div>
				<h2 style='font-size: 20px';><a href="messages.php?u=<?php echo $first_message_uname; ?>" style="text-decoration: none; color: #828182;">Message</a>  |  <a href="buddylist.php" style="text-decoration: none; color: #505050;" >Chat(<?php echo $buddyList; ?>)</a></h2><br />
			</div>
						...
						if (mysqli_num_rows($check)===1) {
							...
							if ($username != $user) {
								if (isset($_POST['submit'])) { 
									...
									$msg_body = ($msg_body);//mysqli_real_escape_string
									$date = date("Y-m-d");
									$opened = "no";
									...
									$messages = mysqli_query($conn,"INSERT INTO pvt_messages VALUES ('','$user','$username','$msg_body','$date','','$opened','$getid')");
								...
								$get_gender = mysqli_query($conn,"SELECT * FROM users WHERE username='$username'");
			...
			$profile_pic = "userdata/profile_pics/".$profile_pic_db;
										...
										<div style='margin: 10px;'>
											...
											<div style='margin: 0 0 0 50px;'>
												<b><a href='profile.php?u=$user_by' style='text-decoration: none; font-size: 14px; color: #505050; font-weight: 700;' title=\"Go to $posted_by's Profile\" >$posted_by</a></b>
