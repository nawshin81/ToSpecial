...
<body>
	...
	echo '<li style="float: right;">
					...
					<div >
						...
						<li><a href="doctor_about.php?u='.$username.'" style="background-color: #cdcdcd; color: #505050">About</a></li>
	...
	$about_query = mysqli_query($conn,"SELECT doctor.work_as,doctor.work_in,doctor.specialist,doctor.academic,users.city,users.hometown,users.queote,users.bio,users.mobile,users.pub_email FROM users,doctor WHERE users.username='$username' and doctor.username='$username'");
					$get_result = mysqli_fetch_assoc($about_query);
					$work_in=$get_result['work_in'];
					$work_as=$get_result['work_as'];
					$specialist=$get_result['specialist'];
					$academic=$get_result['academic'];
	...
	echo '<div class="uiaccountstyle" style="text-align: left; height: auto; width: 507px; padding: 25px; margin: 15px auto;">
		<div>
			<p style="font-size: 13px; font-weight: bold; color: #959695;">WORK & EDUCATION';
				if ($user==$username) {
			...
			<hr style="background-color: #ddd;">';
					...
					echo '
					<p style="font-size: 15px; margin-left: 25px; font-weight: bold; color: #505050;">'.$work_as.'<br></p>
			<p style=" font-weight: bold; margin-left: 25px; ">'.$work_in.'<br></p></br>
			<p style="font-size: 15px; margin-left: 25px; font-weight: bold; color: #505050;">'.$academic.'<br></p>'
			;
			
		echo '</div>
		<div>
		<br><p style="font-size: 13px; font-weight: bold; color: #959695;">SPECIALIST';
				if ($user==$username) {
					echo '<a href="workedu_update.php" style="float: right; text-decoration: none; font-size: 12px; color: #505050">Edit</a>';	
				}else {
		...
		echo '</p>
			<hr style="background-color: #ddd;">
			<p style=" color: #505050; margin-left: 25px; font-size: 14px; line-height: 18px; "> '.nl2br($specialist).'<br></p>
			<br>

			<div>
		</br><p style="font-size: 13px; font-weight: bold; color: #959695;">COUNTRY';
				if ($user==$username) {
		...
		<div>
		</br><p style="font-size: 13px; font-weight: bold; color: #959695;">CONTACT';
				if ($user==$username) {
		...
		<br><p style="font-size: 13px; font-weight: bold; color: #959695;">ABOUT';
				if ($user==$username) {
