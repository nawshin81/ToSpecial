...
<body>
	...
	echo '<li style="float: right;">
					...
					<div >
						...
						<li><a href="everyone_about.php?u='.$username.'" style="background-color: #cdcdcd; color: #505050">About</a></li>
	...
	$about_query = mysqli_query($conn,"SELECT everyone.work_as,everyone.work_in,everyone.academic,users.city,users.hometown,users.queote,users.bio,users.mobile,users.pub_email FROM users,everyone WHERE users.username='$username' and everyone.username='$username'");
